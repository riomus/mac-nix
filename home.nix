...
in
{
  ...
  programs.zsh= {
    ...
    shellAliases = {
      nixu = "nix flake update ~/.config/nix && nix  --extra-experimental-features nix-command --extra-experimental-features  flakes run nix-darwin -- switch --flake ~/.config/nix --fallback";
      cat = "bat";
      ls = "exa";
    };
    initExtra = ''
